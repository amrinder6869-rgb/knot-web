...
export function CrewSection({ hangoutId, currentUserId, isPlanner, isLive = false }: CrewSectionProps) {
...
console.log('CrewSection.tsx updated with live/light color support.');
