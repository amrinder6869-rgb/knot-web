...
{active === 'hangout'  && <Hangout   members={MEMBERS} knotId={activeKnot?.id} />}
{active === 'split'    && <BillSplit members={MEMBERS} knotId={activeKnot?.id} />}{active === 'members'   && <Members   members={MEMBERS} knotId={activeKnot?.id} />}
