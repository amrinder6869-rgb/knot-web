  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 28, overflowX: 'auto', paddingBottom: 4 }}>
        {knots.slice(0, 5).map(k => (
          <button key={k.id} onClick={() => onSelectKnot(k)}
            style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', flexShrink: 0, transition: 'all 0.15s' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--yellow)'; e.currentTarget.style.background = 'var(--yellow-soft)' }}
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 11, color: 'var(--text3)' }}>{k.count} member{k.count !== 1 ? 's' : ''}</div>
            </div>
          </button>
        ))}
        <button onClick={() => {}}
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', background: 'transparent', border: '1px dashed var(--border2)', borderRadius: 12, cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', flexShrink: 0, fontSize: 13, color: 'var(--text3)' }}>
          + New Knot
        </button>
      </div>
