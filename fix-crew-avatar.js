  ...
  const fetchCrew = useCallback(async () => {
    try {
      ...
      if (profileError || !profiles) {
        console.error('CrewSection profiles error:', profileError)
        setLoading(false)
        return
      }
      ...
      console.log('CrewSection data:', crewData)
      setCrew(crewData)
    } catch (err) {
...
console.log('CrewSection.tsx updated with Avatar component and debug logging.');
